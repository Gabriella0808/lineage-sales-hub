  ...
  <Html lang="en" dir="ltr">
    ...
    <Body style={main}>
      <Container style={container}>
        <Heading style={h1}>Weekly Review Not Completed</Heading>
        <Section style={detailsBox}>
          <Text style={text}>
            <strong>{managerName || 'Sales Manager'}</strong>'s Sales Manager Weekly Review form
            has not been completed for {weekLabel || 'the current week'}.
          </Text>
          <Text style={text}>
