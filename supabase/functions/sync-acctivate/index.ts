...
const allowedSyncTables = ["dealers", "contacts", "kpi_records", "activities", "tasks", "dealer_sales", "dealer_sales_lines", "dealer_invoices", "dealer_invoice_lines", "products", "inventory", "open_sales_orders", "acctivate_sales_reps", "acctivate_sales_managers", "acctivate_territories", "presale_po_lines", "presale_po_summary"] as const;
