...
const SyncPayloadSchema = z.object({
  table: z.enum(["managers", "sales_reps", "territories", "rep_territories", "dealers", "contacts", "kpi_records", "activities", "tasks", "dealer_sales", "dealer_sales_lines", "dealer_invoices", "products", "inventory"]),
